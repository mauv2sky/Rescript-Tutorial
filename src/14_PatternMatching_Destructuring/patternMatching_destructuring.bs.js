...
if (person1.TAG === /* Teacher */0) {
  ...
  if (match.passing) {
    "Congrats " + name$1 + ", nice GPA of " + match.gpa.toString();
  } else {
    "Good luck next semester " + name$1 + "!";
  }
}
...
if (typeof myStatus === "number" || myStatus.TAG !== /* Vacations */0) {
  console.log("Ok.");
} else {
...
var match$1 = person1.reportCard;

message = match$1.passing ? "Congrats " + name$2 + ", nice GPA of " + match$1.gpa.toString() + " you got there!" : "Good luck next semester " + name$2 + "!";
